...
document.getElementsByTagName("button")[0].onmouseout = bfout ;
document.getElementsByTagName("button")[0].onmouseover = rfin
document.getElementsByTagName("button")[1].onmouseout = bfout ;
document.getElementsByTagName("button")[1].onmouseover = rfin ;
document.getElementsByTagName("fieldset")[0].onmouseout = bfout ;
document.getElementsByTagName("fieldset")[0].onmouseover = rfin ;
document.getElementsByTagName("fieldset")[1].onmouseout = bfout ;
document.getElementsByTagName("fieldset")[1].onmouseover = rfin ;
